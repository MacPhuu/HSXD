<template>
  <div v-loading="loadingPage" class="file-child-page">
    <div class="header-action" >
      <div v-if="selectedList.length > 1" class="header-action-selection">
        <button-dropdown> Options
          <el-dropdown-menu slot="dropdown-menu">
            <el-dropdown-item>
              <button-icon v-loading="loadingDownload" icon="Download" @click="handleDownloadMultiFile">Tải xuống</button-icon>
            </el-dropdown-item>
            <el-dropdown-item>
              <el-popconfirm
        ...
        <template v-else>
          <button-dropdown> Options
            <el-dropdown-menu slot="dropdown-menu">
              ...
              <el-dropdown-item>
                <button-icon v-if="currentFile.metaType === metaType.FILE && !currentFile.signState" icon="Key" @click="handleDigitizing(currentFile)">Số hóa</button-icon>
              </el-dropdown-item>
              <el-dropdown-item>
    ...
    <div v-else class="category">
      <div class="breadcrumb-container">
        <el-row :gutter="20" class="category-header">
          <el-col :span="16">
          ...
          <el-col class="search-and-filter" :span="8" style="height: 53px; display: flex; align-items: center; padding-right: 20px">
            <el-select
            ...
            >
              ...
              <el-option-group label="Tags">
                <el-option
                  ...
                  :value="tag._id"
                >
                  <el-tag size="small" type="info" style="height: 28px">{{ tag.name }}</el-tag>
                </el-option>
              </el-option-group>
            </el-select>
            <el-input
      ...
      <div class="page-content">
        <div v-if="!loadingPage && tableData.length" class="table-wrap">
          <div v-if="viewType === config.viewType.LIST" style="width:1000px">
            <el-table
              ref="tableData"
              fit
              :data="pagedTableData"
    ...
    >
      <el-form ref="formFolder" :model="form" label-position="top" :rules="ruleFormFolder">
        ...
        <el-form-item label="Tên Thư Mục" style="display: none">
          <el-input />
        </el-form-item>
      </el-form>
    ...
    >
      ...
      <el-row>
        ...
        >
          ...
          >
            <span>
              <el-tag type="info" size="small" style="height: 28px">{{ tag.name }}</el-tag>
            </span>
          </el-option>
        </el-select>
      </el-row>
