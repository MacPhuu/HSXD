<template>
  <div style="min-height: 100vh">
    <div class="setup-pass-container">
      <el-form
      ...
      >
        ...
        <div class="title-container">
          <h3 class="title-logo">Thiết lập mật khẩu</h3>
        </div>
        <p style="color: #6a7181; line-height: 1.25rem">Chỉ còn một bước để tăng tính bảo mật cho tài khoản của bạn. Hãy thiết lập mật khẩu.</p>
        <br>
        <br>
...
<!--        <p style="color: #6a7181; line-height: 1.25rem">Chỉ còn một bước để tăng tính bảo mật cho tài khoản của bạn. Hãy thiết lập mật khẩu.</p>-->
        ...
        <el-form-item style="display: none" prop="repassword">
          <span class="svg-container">
            <svg-icon icon-class="password" />
          </span>
          <el-input
  ...
  methods: {
    ...
    handleSubmit() {
      this.$refs.loginForm.validate(async valid => {
        if (valid) {
          const data = await ProjectAPI.loginStep2({
...
@supports (-webkit-mask: none) and (not (cater-color: $cursor)) {
  .setup-pass-container .el-input input {
    //color: $cursor;
    &:-webkit-autofill {
